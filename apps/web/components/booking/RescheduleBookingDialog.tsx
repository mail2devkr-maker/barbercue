...
export function RescheduleBookingDialog({
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      // Same race BookingFlow guards against: the grid is advisory, the reschedule transaction is
      // authoritative. If another booking took this slot concurrently, drop the stale selection and
      // reload the grid so the now-occupied time shows black instead of staying selectable.
