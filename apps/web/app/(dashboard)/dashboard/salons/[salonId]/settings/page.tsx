  ...
  return (
    <main className={styles.page}>
      ...
      {/* Payment QR moved up here (Part 1, shop-onboarding mission): this settings page is exactly
          ...
          checklist/status sections. Interrupting onboarding here is safe by construction: the shop
          already exists, WALK_IN bookings already work, and this same section (plus the checklist
          entry below) is reachable any time the owner comes back to finish it. */}
      {salon && <PaymentQrSection salonId={salonId} />}
      {salon && (
