...
import { DASHBOARD_PATHS, DISCOVERY_PATHS, SalonSetupErrorCode, SalonStatus, salonPhotoUrlSchema } from "@barbercue/shared";
import type {
...
function PaymentQrSection({ salonId }: { salonId: string }) {
